...
def relay_control():
    ...
    water_sub = rospy.Subscriber('waterpump_signal', Bool, waterpump_callback)

    relay_sub = rospy.Subscriber('power', Bool, power_callback)

    fan_sub = rospy.subscriber('fan', Bool, fan_callback)
